...
export default function LoginPage() {
  ...
  const onSubmit = (data: LoginTypes) => {
    console.log(data);
    if (
      data.userName === import.meta.env.VITE_USERNAME_ADMIN &&
      data.password === import.meta.env.VITE_PASSWORD_ADMIN
    ) {
      login();
      navigate("/admin");
    } else {
  ...
  return (
    <div className="relative bg-[url('/terreno.webp')] bg-cover  min-h-[80vh] lg:h-screen">
