...
const Nosotros = () => {
  return (
    <div className="bg-[url('/terreno.webp')]  bg-cover bg-center flex justify-center items-start p-10">
      <div className="bg-white bg-opacity-90  shadow-lg p-8  w-full rounded-lg">
        ...
        <p>
          Somos una <strong>inmobiliaria de confianza en Tucumán</strong> con
          más de 30 años de experiencia en el mercado inmobiliario. Nuestro
          equipo altamente capacitado está aquí para ayudarte en la compra,
          venta y alquier de propiedades. Brindamos un servicio profesional y
          personalizado para hacer realidad tus objetivos inmobiliarios.
        </p>
